...
the same spatial extent. At least one dataset should be a set of points; atleast 
...
* [Open a spatial data set from a file (R)](https://c-voulgaris.github.io/VIS-2128-F22/a1-files/skill-open-file.html){target="_blank"}
